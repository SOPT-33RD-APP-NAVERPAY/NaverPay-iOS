...
extension UserBenefitDataAppData {
    static func dummy() -> UserBenefitDataAppData {
            ...
            UserBenefitDataAppData(userName: "곽성준", userPoint: 11500, brandList: [
                ...
                BrandListAppData(id: 2, logoImgURL: ImageLiterals.BenefitView.typeAd1, name: "파리바게뜨", discountContent: "네이버페이 회원은 매일", discountType: "더블혜택", isBrandLike: true),
                BrandListAppData(id: 3, logoImgURL: ImageLiterals.BenefitView.typeAd1, name: "신라호텔", discountContent: "30만원 이상 결제 시", discountType: "더블혜택", isBrandLike: false)])
